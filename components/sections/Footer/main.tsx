...
import { COLORS, GRADIENT_FOOTER } from "@/components/constants/palette";
import {
  BackgroundDecor,
  AmbientGlow,
  BrandHeader,
    ...
    >
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 md:gap-12 mb-12 sm:mb-14">
          {/* Quick Links */}
          <FooterCard heading="॥ Explore ॥" mandalaClassName="footer-card-mandala">
          ...
          {/* Social Links */}
          <FooterCard heading="॥ Follow ॥" mandalaClassName="footer-card-mandala">
