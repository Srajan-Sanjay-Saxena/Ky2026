...
const quickLinks = [
  { 
    ...
    href: "#events",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-4 h-4 sm:w-5 sm:h-5 animate-pulse">
  ...
  { 
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-4 h-4 sm:w-5 sm:h-5">
        ...
        <circle cx="12" cy="15" r="2" fill="currentColor" className="animate-ping" style={{ animationDuration: "2s" }}/>
      </svg>
    )
  },
  { 
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-4 h-4 sm:w-5 sm:h-5">
        ...
        <line x1="20" y1="8" x2="20" y2="14" className="animate-bounce" style={{ transformOrigin: "center", animationDuration: "1s" }}/>
    ...
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-4 h-4 sm:w-5 sm:h-5">
        ...
        <polyline points="22,6 12,13 2,6">
          <animate attributeName="points" values="22,6 12,13 2,6; 22,6 12,11 2,6; 22,6 12,13 2,6" dur="2s" repeatCount="indefinite"/>
        </polyline>
      </svg>
    )
  },
      ...
      >
        ...
        <div className="text-center mb-12 sm:mb-14 md:mb-16">
          <h3
            ...
            style={{
              ...
              textShadow: "0 0 30px rgba(255,215,0,0.5), 0 2px 4px rgba(0,0,0,0.4)",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 md:gap-12 mb-12 sm:mb-14">
          ...
          <div 
            ...
            style={{
              background: "linear-gradient(135deg, rgba(61,10,24,0.6) 0%, rgba(90,15,37,0.4) 50%, rgba(61,10,24,0.6) 100%)",
              border: "1px solid rgba(255,215,0,0.4)",
              boxShadow: "inset 0 0 50px rgba(255,215,0,0.08), 0 0 30px rgba(255,215,0,0.1), 0 4px 20px rgba(0,0,0,0.4)",
            }}
          >
            ...
            {/* Corner decorations */}
            <div className="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 rounded-tl-lg" style={{ borderColor: COLORS.BRIGHT_GOLD, opacity: 0.7 }} />
            <div className="absolute top-0 right-0 w-8 h-8 border-t-2 border-r-2 rounded-tr-lg" style={{ borderColor: COLORS.BRIGHT_GOLD, opacity: 0.7 }} />
            <div className="absolute bottom-0 left-0 w-8 h-8 border-b-2 border-l-2 rounded-bl-lg" style={{ borderColor: COLORS.BRIGHT_GOLD, opacity: 0.7 }} />
            <div className="absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 rounded-br-lg" style={{ borderColor: COLORS.BRIGHT_GOLD, opacity: 0.7 }} />
                ...
                <li key={i}>
                  <a
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.textShadow = "0 0 15px rgba(255,215,0,0.5)";
                    }}
                    onMouseLeave={(e) => {
        ...
        <div
          ...
          style={{ background: `linear-gradient(90deg, transparent 0%, rgba(255,215,0,0.4) 20%, rgba(255,215,0,0.6) 50%, rgba(255,215,0,0.4) 80%, transparent 100%)` }}
        />
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6">
          ...
          >
            Made with <span className="text-lg" style={{ color: COLORS.SAFFRON }}>🪔</span> in the City of Light
          </p>
        </div>
      </div>
