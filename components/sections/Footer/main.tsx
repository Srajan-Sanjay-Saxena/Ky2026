  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, #8B1538, #FFD700, #FF6B00, #FFD700, #8B1538)",
        }}
      />
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-10 mb-8 sm:mb-10 md:mb-12">
            ...
            <div className="flex gap-3 sm:gap-4 justify-center sm:justify-start">
              {socialLinks.map((link, i) => (
                <a
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(255,215,0,0.2), rgba(139,21,56,0.2))",
          ...
          <div className="text-center sm:text-left">
            <h4 className="text-[#FFD700] font-semibold mb-3 sm:mb-4 text-sm sm:text-base">
              Quick Links
            </h4>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at bottom, rgba(255,107,0,0.1), transparent 70%)",
        }}
      />
    </footer>
  );
