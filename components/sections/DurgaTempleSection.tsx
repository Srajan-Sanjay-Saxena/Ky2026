...
const Trishul = ({ className = "" }: { className?: string }) => (
  <svg viewBox="0 0 60 120" className={className} fill="currentColor">
    <path d="M28 120V45M28 45L15 25L28 35L28 10L32 10L32 35L45 25L32 45M30 10L30 0M25 8L30 0L35 8" 
...
const MandalaRing = ({ className = "" }: { className?: string }) => (
  <svg viewBox="0 0 200 200" className={className}>
    ...
    {[...Array(12)].map((_, i) => (
      <line key={i} x1="100" y1="5" x2="100" y2="25" stroke="currentColor" strokeWidth="0.5" opacity="0.4"
        transform={`rotate(${i * 30} 100 100)`}/>
    ))}
    {[...Array(24)].map((_, i) => (
      <circle key={i} cx="100" cy="15" r="2" fill="currentColor" opacity="0.3"
...
const highlights = [
  { icon: "🎭", title: "Cultural Nights", desc: "Classical dance & music performances" },
...
export default function DurgaTempleSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-[20%] -translate-x-1/2 -translate-y-1/2 w-[250px] sm:w-[350px] md:w-[400px] lg:w-[500px] h-[250px] sm:h-[350px] md:h-[400px] lg:h-[500px] pointer-events-none opacity-15" style={{ animation: 'spin 60s linear infinite' }}>
        <MandalaRing className="w-full h-full text-[#FF6B00]" />
      </div>

      {/* Floating Decorative Elements - reduced on mobile */}
      <div ref={decorRef} className="absolute inset-0 pointer-events-none overflow-hidden z-30">
      ...
      <div 
        className="absolute right-0 bottom-0 w-[35%] sm:w-[30%] md:w-[28%] lg:w-[25%] xl:w-[22%] pointer-events-none z-20"
      >
        {/* Divine aura behind Durga */}
        <div
          className="absolute inset-[-30%] rounded-full pointer-events-none"
          style={{
            background: "radial-gradient(circle, rgba(255,69,0,0.15) 0%, rgba(176,63,35,0.08) 40%, transparent 70%)",
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(255,215,0,0.12) 0%, rgba(255,140,0,0.06) 40%, transparent 70%)",
        ...
        <Image
          ...
          style={{
            filter: "drop-shadow(0 0 30px rgba(255,69,0,0.5)) drop-shadow(0 0 60px rgba(255,215,0,0.3))",
        ...
        <div
          ...
          style={{
            background: "radial-gradient(ellipse 100% 100% at 50% 100%, rgba(255,140,0,0.4) 0%, transparent 70%)",
            filter: "blur(10px)",
          }}
        />
      </div>
      ...
      >
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle at center, #B03F23 0%, transparent 60%)",
          }}
        />
      ...
      <div className="relative z-10 min-h-[60vh] sm:min-h-[70vh] lg:min-h-[85vh] flex items-center">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center lg:justify-end">
            <div ref={contentRef} className="w-full lg:w-[42%] xl:w-[38%] lg:pr-8 text-center lg:text-left">
              <span
              ...
              <p
                ...
                style={{ color: "#FDF6E3" }}
              >
                Step into a world where ancient traditions meet modern celebrations. 
                Kashi Yatra brings you three electrifying days of music, dance, 
              ...
              <p
                ...
                style={{ color: "#FDF6E3" }}
              >
                From soul-stirring classical performances to heart-pounding DJ nights, 
                from intense hackathons to creative showcases — there&apos;s something 
                for everyone at the biggest fest of the year.
              </p>
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-4 sm:mb-6">
                {highlights.map((item, i) => (
                  <div
                    ...
                    style={{
                      background: "linear-gradient(135deg, rgba(176,63,35,0.4), rgba(45,24,16,0.6))",
                      border: "1px solid rgba(255,107,0,0.4)",
                  ...
                  >
                    ...
                    <h4 className="font-bold text-[#FFD700] text-xs sm:text-sm mb-0.5 sm:mb-1">{item.title}</h4>
                    <p className="text-[10px] sm:text-xs text-[#FDF6E3] opacity-70">{item.desc}</p>
                  </div>
                ))}
              </div>
