    ...
    <section className="relative min-h-[70vh] sm:min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="hidden lg:block absolute -right-20 top-1/2 -translate-y-1/2 w-[500px] h-[600px] pointer-events-none">
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, rgba(0,180,150,0.2) 0%, rgba(255,215,0,0.1) 40%, transparent 70%)",
            filter: "blur(50px)",
        ...
        <Image 
          ...
          style={{
            filter: "drop-shadow(0 0 40px rgba(0,180,150,0.5)) drop-shadow(0 0 80px rgba(255,215,0,0.3))",
          }}
        />
      </div>
      ...
      <div className="absolute -bottom-2 sm:bottom-0 left-1/2 -translate-x-1/2 w-56 sm:w-80 md:w-96 pointer-events-none opacity-80">
        <Image
          ...
          style={{ filter: "drop-shadow(0 0 30px rgba(255,180,50,0.6)) drop-shadow(0 0 60px rgba(255,150,50,0.3))" }}
        />
      </div>
    </section>
  );
