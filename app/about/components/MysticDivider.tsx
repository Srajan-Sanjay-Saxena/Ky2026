  ...
  return (
    <div className={`flex justify-center ${className}`}>
      <div className="relative">
        ...
        <div 
          className="hidden sm:block absolute inset-0 -inset-x-10"
          style={{
            background: "radial-gradient(ellipse at center, rgba(255,215,0,0.3) 0%, rgba(255,180,50,0.15) 40%, transparent 70%)",
            filter: "blur(20px)",
          }}
        />
        <Image
          src={IMAGES.about.mysticDivider}
          alt=""
          width={600}
          height={60}
