  ...
  return (
    <div className="hidden lg:block absolute inset-0 overflow-hidden pointer-events-none" aria-hidden>
      ...
      <div
        ...
        style={{ animation: `spin 160s linear infinite reverse`, animationPlayState: play }}
      >
      ...
      <div className="absolute -right-24 top-1/3 -translate-y-1/2 w-[440px] h-[560px]">
        ...
        <Image
          ...
          style={{
            filter: "drop-shadow(0 0 40px rgba(0,180,150,0.4)) drop-shadow(0 0 80px rgba(255,215,0,0.25))",
          }}
        />
      </div>
